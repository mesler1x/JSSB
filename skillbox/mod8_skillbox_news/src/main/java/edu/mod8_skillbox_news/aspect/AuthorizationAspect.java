package edu.mod8_skillbox_news.aspect;
...
public class AuthorizationAspect {
    ...
    @Before("@annotation(edu.mod8_skillbox_news.aspect.RequiresNewsOwnership)")
    ...
    @Before("@annotation(edu.mod8_skillbox_news.aspect.RequiresCommentOwnership)")
